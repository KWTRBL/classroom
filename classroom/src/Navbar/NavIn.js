  ...
  render() {
    return (
      <div>
        ...
        >
          <Navbar.Brand>
            <img src={kmitlEng} className="Logokmitl" alt="logokmitl" />
          </Navbar.Brand>
          <Navbar.Toggle aria-controls="responsive-navbar-nav" />
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="mr-auto">
              <NavDropdown title="ข้อมูลในคณะ" id="collasible-nav-dropdown">
                <NavDropdown.Item href="/FacultyData">
                  ข้อมูลหน่วยงานในคณะ
                </NavDropdown.Item>
              ...
              <NavDropdown title="การจัดการคุมสอบ" id="collasible-nav-dropdown">
                ...
                <NavDropdown.Item href="/ManageIn">
                  จัดกรรมการคุมสอบ
                </NavDropdown.Item>
                <NavDropdown.Item href="/ExchangeIn">
                  แลกวันสอบและคุมสอบแทน
                </NavDropdown.Item>
              </NavDropdown>
              <NavDropdown title="รายงานการคุมสอบ" id="collasible-nav-dropdown">
                <NavDropdown.Item href="/ReportIn">
                  รายงานผลการจัดผู้คุมสอบ
                </NavDropdown.Item>
              </NavDropdown>
            </Nav>
            <Nav>
