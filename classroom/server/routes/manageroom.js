...
function getRow(query,year,semester,curr2_id,teach_day) {
  ...
  function updateOldroom(query_updateoldroom,year,semester,curr2_id,teach_day,oldroom,subject){
    return new Promise(function(resolve,reject){
        pool.query(query_updateoldroom,[oldroom,teach_day,semester,year,oldroom,semester,curr2_id,teach_day,year,subject,semester,year,teach_day,oldroom,oldroom], async (err, updatedroom) => {
        if(err){
          reject(err)
        }else{
